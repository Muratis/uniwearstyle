...
return [
    ...
    */
    ...
    'title' => 'UniwearStyle administrator',
    ...
    */
    ...
    'logo'      => '  <span class="pull-left"><img src="/images/logo.jpg" style="width: 43px; height: 43px; border-radius: 50%;" class="img"> UniwearStyle</span>',
    'logo_mini' => '<img src="/images/logo.jpg" style="width: 43px; height: 43px; border-radius: 50%;">',
