...
use App\Models\Articles\Article_NMU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Article_NMU::class, function (ModelConfiguration $model) {

	$model->setTitle('Новости NMU Style ');
	$model->setAlias('articles_nmu');
