...
use App\Models\Articles\Article_KNEU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Article_KNEU::class, function (ModelConfiguration $model) {

	$model->setTitle('Новости KNEU Style ');
	$model->setAlias('articles_kneu');
