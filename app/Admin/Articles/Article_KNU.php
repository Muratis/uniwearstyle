...
use App\Models\Articles\Article_KNU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Article_KNU::class, function (ModelConfiguration $model) {

	$model->setTitle('Новости KNU Style ');
	$model->setAlias('articles_knu');
