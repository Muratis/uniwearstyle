...
use App\Models\Cataloge_admin\Poloes;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Poloes::class, function (ModelConfiguration $model) {

	$model->setTitle('Poloes');
	$model->setAlias('poloes');
	...
	$model->onDisplay(function () {
		...
		$display->SetTabs(function ()
		{
			...
			$columns = [
				...
				AdminColumn::text('gender', 'Пол')->setWidth('200px'),
	...
	$model->onCreateAndEdit(function () {
		$form = AdminForm::panel()->addBody(
			...
			AdminFormElement::hidden('clothes_type')->setDefaultValue('polo'),
