...
use App\Models\Tshirts\Tshirt_NMU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Tshirt_NMU::class, function (ModelConfiguration $model) {

	$model->setTitle('Футболки NMU Style ');
	$model->setAlias('tshirts_nmu');
