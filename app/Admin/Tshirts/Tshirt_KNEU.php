...
use App\Models\Tshirts\Tshirt_KNEU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Tshirt_KNEU::class, function (ModelConfiguration $model) {

	$model->setTitle('Футболки KNU Style');
	$model->setAlias('tshirts_kneu');
