...
use App\Models\Bombers\Bomber_KNEU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Bomber_KNEU::class, function (ModelConfiguration $model) {

	$model->setTitle('Бомберы KNEU Style ');
	$model->setAlias('bombers_kneu');
