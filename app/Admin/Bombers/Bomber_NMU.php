...
use App\Models\Bombers\Bomber_NMU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Bomber_NMU::class, function (ModelConfiguration $model) {

	$model->setTitle('Бомберы NMU Style ');
	$model->setAlias('bombers_nmu');
