...
use App\Models\Bombers\Bomber_KPI;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Bomber_KPI::class, function (ModelConfiguration $model) {

	$model->setTitle('Бомберы KPI Style ');
	$model->setAlias('bombers_kpi');
