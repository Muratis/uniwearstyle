...
use App\Models\Polo\Polo_KNU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Polo_KNU::class, function (ModelConfiguration $model) {

	$model->setTitle('Поло KNU Style ');
	$model->setAlias('polo_knu');
