...
use App\Models\Polo\Polo_NMU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Polo_NMU::class, function (ModelConfiguration $model) {

	$model->setTitle('Поло NMU Style ');
	$model->setAlias('polo_nmu');
