...
use App\Models\Polo\Polo_KPI;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Polo_KPI::class, function (ModelConfiguration $model) {

	$model->setTitle('Поло KPI Style ');
	$model->setAlias('polo_kpi');
