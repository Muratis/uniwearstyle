...
use App\Models\Sweatshirts\Sweatshirt_KNEU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Sweatshirt_KNEU::class, function (ModelConfiguration $model) {

	$model->setTitle('Свитшоты KNEU Style ');
	$model->setAlias('sweatshirts_kneu');
