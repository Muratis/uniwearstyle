...
use App\Models\Sweatshirts\Sweatshirt_KNU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Sweatshirt_KNU::class, function (ModelConfiguration $model) {

	$model->setTitle('Свитшоты KNU Style ');
	$model->setAlias('sweatshirts_knu');
