...
use App\Models\Sweatshirts\Sweatshirt_KPI;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Sweatshirt_KPI::class, function (ModelConfiguration $model) {

	$model->setTitle('Свитшоты KPI Style ');
	$model->setAlias('sweatshirts_kpi');
