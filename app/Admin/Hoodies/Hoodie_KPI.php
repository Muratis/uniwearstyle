...
use App\Models\Hoodies\Hoodie_KPI;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Hoodie_KPI::class, function (ModelConfiguration $model) {

	$model->setTitle('Худи KPI Style ');
	$model->setAlias('hoodies_kpi');
