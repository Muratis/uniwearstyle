...
use App\Models\Hoodies\Hoodie_KNEU;
use SleepingOwl\Admin\Model\ModelConfiguration;
AdminSection::registerModel(Hoodie_KNEU::class, function (ModelConfiguration $model) {

	$model->setTitle('Худи KNEU Style ');
	$model->setAlias('hoodies_kneu');
