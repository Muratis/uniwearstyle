...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <h1><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Логи Uniwear Style</h1>
      <div class="list-group">
        ...
        @endforeach
          <button class="btn btn-back"><a href="/admin">Вернутися на панель</a></button>
      </div>
    </div>
